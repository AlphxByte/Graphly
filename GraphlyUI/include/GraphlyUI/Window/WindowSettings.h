...
namespace GraphlyUI
{
	...
	private:
		WindowStyleFlags styleFlags = WindowStyleFlags::OverlappedWindow;
	...
	public:
		...
		WindowSettings& SetBackgroundColor(const GraphlyMath::Vector3& bgColor);
		...
		const GraphlyMath::Vector3& GetBackgroundColor() const;
	...
	private:
		...
		GraphlyMath::Vector3 backgroundColor{ 255, 255, 255 };
		WindowStyle style;
		int nCmdShow{};
